...
migración **52** y sus invariantes; los archivos SQL de `src-tauri/migrations/` son la fuente
...
| 52 | `release_state_of_the_wishlist` | Qué deseados están por salir, sabido de golpe en vez de uno a uno. |
